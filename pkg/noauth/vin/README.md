# [github.com/bitcrook/cycull/noauth/vin](https://github.com/bitcrook/cycull/tree/main/noauth/vin) - no authentication required
...
import (
	...
	"github.com/bitcrook/cycull/noauth/vin"
)
...
func main() {
	...
	fmt.Println(x.MadeInCity + ", " + x.MadeIn)
}
```
