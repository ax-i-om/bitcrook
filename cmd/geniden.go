...
import (
	...
	"github.com/audioo/goseek/helpers/opsec"
...
func init() {
	...
	// genidenCmd.PersistentFlags().String("foo", "", "A help for foo")

	// Cobra supports local flags which will only run when this command
	// is called directly, e.g.:
	// genidenCmd.Flags().BoolP("toggle", "t", false, "Help message for toggle")
}
