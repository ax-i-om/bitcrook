...
func RedirSites(userres string) []ent.Website {
	...
	arr = append(arr, ent.Website{Title: "SLIDESHARE", Domain: "https://slideshare.net/" + userres, Delete: "TODO"})
	...
	arr = append(arr, ent.Website{Title: "INSTRUCTABLES", Domain: "https://www.instructables.com/member/" + userres, Delete: "TODO"})
	arr = append(arr, ent.Website{Title: "KEYBASE", Domain: "https://keybase.io/" + userres, Delete: "TODO"})
	arr = append(arr, ent.Website{Title: "KONGREGATE", Domain: "https://kongregate.com/accounts/" + userres, Delete: "TODO"})
	arr = append(arr, ent.Website{Title: "LIVEJOURNAL", Domain: "https://" + userres + ".livejournal.com", Delete: "TODO"})
	arr = append(arr, ent.Website{Title: "LASTFM", Domain: "https://last.fm/user/" + userres, Delete: "TODO"})
	arr = append(arr, ent.Website{Title: "DRIBBBLE", Domain: "https://dribbble.com/" + userres, Delete: "TODO"})
	arr = append(arr, ent.Website{Title: "CODECADEMY", Domain: "https://www.codecademy.com/profiles/" + userres, Delete: "TODO"})
	arr = append(arr, ent.Website{Title: "GRAVATAR", Domain: "https://en.gravatar.com/" + userres, Delete: "TODO"})
	arr = append(arr, ent.Website{Title: "PASTEBIN", Domain: "https://pastebin.com/u/" + userres, Delete: "TODO"})
	arr = append(arr, ent.Website{Title: "ROBLOX", Domain: "https://www.roblox.com/user.aspx?username=" + userres, Delete: "TODO"})
	arr = append(arr, ent.Website{Title: "GUMROAD", Domain: "https://www.gumroad.com/" + userres, Delete: "TODO"})
	...
	arr = append(arr, ent.Website{Title: "TRAKT", Domain: "https://www.trakt.tv/users/" + userres, Delete: "TODO"})
	arr = append(arr, ent.Website{Title: "BUZZFEED", Domain: "https://buzzfeed.com/" + userres, Delete: "TODO"})
	arr = append(arr, ent.Website{Title: "TRIPADVISOR", Domain: "https://www.tripadvisor.com/Profile/" + userres, Delete: "TODO"})
	...
	arr = append(arr, ent.Website{Title: "WIKIPEDIA", Domain: "https://en.wikipedia.org/wiki/User:" + userres, Delete: "TODO"})
	...
	arr = append(arr, ent.Website{Title: "BANDCAMP", Domain: "https://www.bandcamp.com/" + userres, Delete: "TODO"})
	arr = append(arr, ent.Website{Title: "COLOURLOVERS", Domain: "https://www.colourlovers.com/lover/" + userres, Delete: "TODO"})
	arr = append(arr, ent.Website{Title: "IFTTT", Domain: "https://www.ifttt.com/p/" + userres, Delete: "TODO"})
	arr = append(arr, ent.Website{Title: "SLACK", Domain: "https://" + userres + ".slack.com", Delete: "TODO"})
	arr = append(arr, ent.Website{Title: "ELLO", Domain: "https://ello.co/" + userres, Delete: "TODO"})
	...
	arr = append(arr, ent.Website{Title: "Audio Jungle", Domain: "https://audiojungle.net/user/" + userres + "", Delete: "TODO"})
	...
	arr = append(arr, ent.Website{Title: "CNET", Domain: "https://www.cnet.com/profiles/" + userres + "/", Delete: "TODO"})
	...
	arr = append(arr, ent.Website{Title: "Discogs", Domain: "https://www.discogs.com/user/" + userres + "", Delete: "TODO"})
	...
	arr = append(arr, ent.Website{Title: "FreeSound", Domain: "https://freesound.org/people/" + userres + "/", Delete: "TODO"})
	...
	arr = append(arr, ent.Website{Title: "Issuu", Domain: "https://issuu.com/" + userres + "", Delete: "TODO"})
	...
	arr = append(arr, ent.Website{Title: "Letterboxd", Domain: "https://letterboxd.com/" + userres + "", Delete: "TODO"})
	arr = append(arr, ent.Website{Title: "Lichess", Domain: "https://lichess.org/@/" + userres + "", Delete: "TODO"})
	arr = append(arr, ent.Website{Title: "Memrise", Domain: "https://www.memrise.com/user/" + userres + "/", Delete: "TODO"})
	...
	arr = append(arr, ent.Website{Title: "MySpace", Domain: "https://myspace.com/" + userres + "", Delete: "TODO"})
	...
	arr = append(arr, ent.Website{Title: "Rate Your Music", Domain: "https://rateyourmusic.com/~" + userres + "", Delete: "TODO"})
	...
	arr = append(arr, ent.Website{Title: "SourceForge", Domain: "https://sourceforge.net/u/" + userres + "", Delete: "TODO"})
	...
	arr = append(arr, ent.Website{Title: "Couch Surfing", Domain: "https://www.couchsurfing.com/people/" + userres + "", Delete: "TODO"})
	...
	arr = append(arr, ent.Website{Title: "Geocaching", Domain: "https://www.geocaching.com/p/default.aspx?u=" + userres + "", Delete: "TODO"})
